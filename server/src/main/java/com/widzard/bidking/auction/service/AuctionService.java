...
public interface AuctionService {
    ...
    Page<AuctionRoom> readAuctionRoomList(AuctionListRequest auctionListRequest);

    AuctionListBookmarkResponse readAuctionRoomListWithLoginStatus(
        AuctionListRequest auctionListRequest, Member member);

    Page<AuctionRoom> readAuctionRoomListOnlyBookmarked(AuctionListRequest auctionListRequest,
        Member member);
