        ...
        {isWithinTwentyMinutes && (
          <div>
            ...
            >
              ...
              >
                <QuestionModal
                  content1="판매하고자 하는 상품의 정보는 정확하고 사실에 근거하여야 합니다. 오해를 초래할 수 있는 허위 또는 부정확한 정보 제공은 금지됩니다. 상품의 사진은 현재 상태를 정확하게 반영한 것이어야 하며, 상품 설명 또한 충실하게 작성되어야 합니다."
                  content2="상품이 낙찰되면, 판매자는 거래를 완료하는 책임이 있습니다. 이에 따라 상품을 안전하게 포장하고 지정된 시간 내에 발송해야 합니다. 판매된 상품에 문제가 있거나 설명과 상이할 경우, 반품 또는 교환에 대한 책임이 발생할 수 있습니다."
                />
              </div>
              <Spacing rem="1" dir="h" />
              <div
